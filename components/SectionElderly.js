            ...
            <div className="mt-20">
                ...
                <div className="max-w-5xl mx-auto space-y-4">
                     ...
                     <Accordion title="Systemic Gaps and Policy Recommendations">
                        <p>Despite these efforts, significant systemic gaps remain. There&apos;s a critical shortage of healthcare professionals trained in the specific needs of older adults. Ageism is still prevalent in policy and practice. Key policy recommendations include: 1) The establishment of a universal, non-contributory social pension for all citizens above a certain age (e.g., 70) to provide a basic income floor. 2) Investing in training for healthcare workers in geriatrics and integrating geriatric care into the PHC system. 3) Strengthening partnerships with NGOs and CBOs to expand the reach of social support services, particularly in rural areas. 4) Launching public awareness campaigns to combat ageism and promote the value and dignity of older persons.</p>
                     </Accordion>
                 </div>
            </div>
        </section>
